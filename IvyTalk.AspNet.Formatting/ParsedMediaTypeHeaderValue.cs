...
{
    internal readonly struct ParsedMediaTypeHeaderValue
    {
        ...
        public ParsedMediaTypeHeaderValue(MediaTypeHeaderValue mediaTypeHeaderValue)
        {
            ...
            Contract.Assert(_delimiterIndex > 0,
        ...
        public bool TypesEqual(ref ParsedMediaTypeHeaderValue other)
        {
            ...
            return String.Compare(_mediaType, 0, other._mediaType, 0, _delimiterIndex,
        ...
        public bool SubTypesEqual(ref ParsedMediaTypeHeaderValue other)
        {
            ...
            return String.Compare(_mediaType, _delimiterIndex + 1, other._mediaType, other._delimiterIndex + 1,
                _subTypeLength, StringComparison.OrdinalIgnoreCase) == 0;
        }
    }
}